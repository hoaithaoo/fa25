...
//        StoreStock storeStock = storeStockService.getStoreStockByStoreIdAndModelColorId(store.getStoreId(), model.getModelId(), color.getColorId());
//
//        // Validate stock availability
//        if (!validateStockAvailability(request.getStoreStockId(), request.getQuantity())) {
