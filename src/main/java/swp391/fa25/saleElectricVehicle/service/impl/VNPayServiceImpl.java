...
@Service
public class
VNPayServiceImpl implements VNPayService {
    ...
    public String buildPaymentUrl(PaymentRequest paymentRequest) {
        Payment payment = paymentService.getPaymentEntityById(paymentRequest.getPaymentId());
...
//        resp.getWriter().write(gson.toJson(job));
    ...
    public boolean validateChecksum(Map<String, String> params) {
        ...
        // Remove vnp_SecureHash from params before hashing
    ...
    @Override
    public boolean validateAmount(String paymentCode, BigDecimal amount) {
